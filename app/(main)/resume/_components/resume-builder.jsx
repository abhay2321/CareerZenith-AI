    ...
    <div data-color-mode="light" className="space-y-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Textarea
                    {...field}
                    className="h-32"
                    placeholder="Write here the professional summery..."
        ...
        <TabsContent value="preview">
          ...
          {resumeMode !== "preview" && (
            <div className="flex items-center gap-3 rounded-sm bg-yellow-100 p-4 text-sm text-yellow-800 mb-2 border border-amber-300">
